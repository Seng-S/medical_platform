...
<body class="bg-light">
  ...
  <header>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary" style="background-color: tomato">
      ...
      <ul class="navbar-nav">
        <li><a href="loginclient.php" class="nav-link">Client Login</a></li>
  ...
  <form class="row g-3 container mx-auto mt-4" id="register">
    ...
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="inputPhone" placeholder="0123456789" name="phonenumber" required>
    </div>

    <div class="col-md-6">
      <label for="inputEmail4" class="form-label">Email</label>
      <input type="email" class="form-control" id="inputEmail4" placeholder="MickGuttenberg@gmail.com" name="email" required>
    </div>

    <div class="col-md-6">
      <label for="inputPassword4" class="form-label">Password</label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="Password" name="password" required><br>
    </div>
  ...
  <script>
    ...
    $(document).ready(function(){
      ...
      $("#register").on("submit", function(e){
          $.ajax({
              url: '../../routes/client/clientSignUp.php',
              type: 'post',
